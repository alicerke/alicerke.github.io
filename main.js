...
module.exports = __webpack_require__(/*! E:\Frontend\Vizsga\str-frontend-kepesito-vizsga\angular-cinema-project\cinema\src\main.ts */"zUnb");
...
class HttpService {
    constructor(http) {
        this.http = http;
        this.BASE_URL = 'https://tr360-frontend-exam-april.azurewebsites.net/alicerke/movies';
    }
    getMovieList() {
...
/* harmony import */ var _service_http_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../service/http.service */ "9NvV");
...
function MovieListComponent_tr_14_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function MovieListComponent_tr_14_Template_button_click_8_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r3); const movie_r1 = ctx.$implicit; const ctx_r2 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](); return ctx_r2.deleteMovie(movie_r1); });
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate"](movie_r1.year);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate"](movie_r1.category);
} }
class MovieListComponent {
    constructor(httpService) {
        this.httpService = httpService;
        this.movies = new rxjs__WEBPACK_IMPORTED_MODULE_0__["Observable"]();
    }
    ngOnInit() {
    }
    getMovies() {
    ...
    deleteMovie(movie) {
        this.httpService.deleteMovie(movie.id).subscribe(() => this.movies = this.httpService.getMovieList());
    }
}
MovieListComponent.ɵfac = function MovieListComponent_Factory(t) { return new (t || MovieListComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_service_http_service__WEBPACK_IMPORTED_MODULE_2__["HttpService"])); };
MovieListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: MovieListComponent, selectors: [["app-movie-list"]], decls: 16, vars: 3, consts: [[1, "table-section"], ["id", "get-button", 3, "click"], ["class", "table-row", 4, "ngFor", "ngForOf"], [1, "table-row"], ["id", "delete-button", 1, "btn", 3, "click"]], template: function MovieListComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "section", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](1, "button", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function MovieListComponent_Template_button_click_1_listener() { return ctx.getMovies(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](2, "Get movie List");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtemplate"](14, MovieListComponent_tr_14_Template, 10, 3, "tr", 2);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("ngForOf", _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵpipeBind1"](15, 1, ctx.movies));
...
MovieDetailsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: MovieDetailsComponent, selectors: [["app-movie-details"]], decls: 7, vars: 3, consts: [[1, "detail-section"], [1, "card"], ["alt", "", 3, "src"]], template: function MovieDetailsComponent_Template(rf, ctx) { if (rf & 1) {
...
MovieComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: MovieComponent, selectors: [["app-movie"]], viewQuery: function MovieComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, decls: 29, vars: 5, consts: [[1, "container-md"], ["mForm", "ngForm"], [1, "form-group", 3, "ngSubmit"], ["for", "title", 1, "text-warning"], ["id", "title", "type", "text", "required", "", "pattern", "^[a-\u0171A-\u0170 ]{5,25}$", "name", "title", 1, "form-control", 3, "ngModel", "ngModelChange"], [1, "row"], [1, "form-group", "col-6"], ["for", "year", 1, "text-warning"], ["id", "year", "type", "text", "required", "", "pattern", "^(19[0-9]{2})|(20([0-1][0-9]|2[0-1]))$", "name", "year", 1, "form-control", 3, "ngModel", "ngModelChange"], ["for", "category", 1, "text-warning"], ["id", "category", "type", "text", "required", "", "pattern", "", "name", "category", 1, "form-control", 3, "ngModel", "ngModelChange"], ["selected", "", "disabled", ""], ["value", "Drama"], ["value", "Action"], ["value", "Fantasy"], ["type", "submit", 1, "btn", "btn-warning", 3, "disabled"], [1, "text-danger", 3, "hidden"]], template: function MovieComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "section", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](1, "form", null, 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](3, "div", 2);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngSubmit", function MovieComponent_Template_div_ngSubmit_3_listener() { return ctx.saveMovie(ctx.movie); });
